...
pygame.mixer.music.load("C:\\Users\\geowa\\OneDrive\\Documentos\\pomodoropy\\assets\\lofi.mp3")
...
START_STOP_BUTTON = Button(WHITE_BUTTON, (WIDTH/2, HEIGHT/2+100), 170, 60, "START", pygame.font.Font("assets/ArialRoundedMTbold.ttf", 20), "#0B5394", "#edcfb3")
POMODORO_BUTTON = Button(None,(WIDTH/2-150, HEIGHT/2-140), 120, 30, "Pomodoro", pygame.font.Font("assets/ArialRoundedMTbold.ttf", 20), "#dbadb8", "#edcfb3" )
SHORT_BREAK_BUTTON = Button(None, (WIDTH/2, HEIGHT/2-140), 120, 30, "Short Break",  pygame.font.Font("assets/ArialRoundedMTbold.ttf", 20), "#dbadb8", "#edcfb3")
LONG_BREAK_BUTTON = Button(None, (WIDTH/2+150, HEIGHT/2-140), 120, 30, "Long Break",  pygame.font.Font("assets/ArialRoundedMTbold.ttf", 20), "#dbadb8", "#edcfb3")

POMODORO_LENGTH = 1500 #1500 secs / 25 mins
SHORT_BREAK_LENGHT = 300 #300 secs / 5 mins
LONG_BREAK_LENGHT = 900 #900 secs / 15 mins
    ...
    for event in pygame.event.get():
        ...
        if event.type == pygame.MOUSEBUTTONDOWN:
            ...
            if SHORT_BREAK_BUTTON.check_for_input(pygame.mouse.get_pos()):
                current_seconds = SHORT_BREAK_LENGHT
                started = False
            if LONG_BREAK_BUTTON.check_for_input(pygame.mouse.get_pos()):
                current_seconds = LONG_BREAK_LENGHT
                started = False
            if started:
                START_STOP_BUTTON.text_input = "STOP"
                START_STOP_BUTTON.text = pygame.font.Font("assets/ArialRoundedMTbold.ttf", 20).render(START_STOP_BUTTON.text_input, True, START_STOP_BUTTON.base_color)
